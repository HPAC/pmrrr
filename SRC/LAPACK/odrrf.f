      SUBROUTINE ODRRF( N, D, L, LD, CLSTRT, CLEND,
     $                  W, WGAP, WERR,
...
*        store new L and D back into DPLUS, LPLUS
         CALL ODCPY( N, WORK, 1, DPLUS, 1 )
         CALL ODCPY( N-1, WORK(N+1), 1, LPLUS, 1 )
      ENDIF

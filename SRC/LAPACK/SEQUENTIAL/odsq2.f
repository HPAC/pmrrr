...
*
*  Note : ODSQ2 defines a logical variable, IEEE, which is true
...
*     .. External Subroutines ..
      EXTERNAL           ODSQ3, ODSRT, OERBLA
*     ..
*     .. External Functions ..
      INTEGER            OIENV
      DOUBLE PRECISION   ODMCH
      EXTERNAL           ODMCH, OIENV
*     ..
*     .. Intrinsic Functions ..
...
*     (in case ODSQ2 is not called by ODSQ1)
*
      INFO = 0
      EPS = ODMCH( 'Precision' )
...
*         
      IEEE = OIENV( 10, 'ODSQ2', 'N', 1, 2, 3, 4 ).EQ.1 .AND.
     $       OIENV( 11, 'ODSQ2', 'N', 1, 2, 3, 4 ).EQ.1      
*         
...
*
            CALL ODSQ3( I0, N0, Z, PP, DMIN, SIGMA, DESIG, QMAX, NFAIL,

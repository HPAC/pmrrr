      SUBROUTINE ODSQ3( I0, N0, Z, PP, DMIN, SIGMA, DESIG, QMAX, NFAIL,
...
*     .. External Subroutines ..
      EXTERNAL           ODSQ4, ODSQ5, ODSQ6
*     ..
*     .. External Function ..
      DOUBLE PRECISION   ODMCH
      LOGICAL            ODNAN
      EXTERNAL           ODNAN, ODMCH
*     ..
*     .. Intrinsic Functions ..
...
*     Choose a shift.
*
      CALL ODSQ4( I0, N0, Z, PP, N0IN, DMIN, DMIN1, DMIN2, DN, DN1,
     $             DN2, TAU, TTYPE, G )
*
...
*
   70 CONTINUE
*
      CALL ODSQ5( I0, N0, Z, PP, TAU, DMIN, DMIN1, DMIN2, DN,
     $             DN1, DN2, IEEE )
*
      NDIV = NDIV + ( N0-I0+2 )
      ITER = ITER + 1
...
*
   80 CONTINUE
      CALL ODSQ6( I0, N0, Z, PP, DMIN, DMIN1, DMIN2, DN, DN1, DN2 )
      NDIV = NDIV + ( N0-I0+2 )
      ITER = ITER + 1
      TAU = ZERO
*

...
*  ODSTMR to compute the eigenvectors of T.
...
*        of the updates would be too much work in ODRRV.
...
*           a uniform ODRRV since dqds computes eigenvalues of the
*           shifted representation. In ODRRV, W will always hold the
